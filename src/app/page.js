...
export default function Home() {
  ...
  const getData = async () => {
    const res = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=717fdd8a6c5af3c28a046275593a7e22${grados}`);
    // console.log(res)
    if (res.ok === true) {
  ...
  const getDay = async () => {
    const res = await fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${city}&appid=717fdd8a6c5af3c28a046275593a7e22${grados}`);
    // console.log(res)
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=717fdd8a6c5af3c28a046275593a7e22${grados}`)
      ...
      <div className="contenedorCardsEstados">
        <section className="sectionSegunda">
          ...
          <section id="estadoDirect">
            ...
            <div id="lastP">
              <p>created by <b><u>@KevinLara</u></b> - devChallenges.io</p>
            </div>
        </section>
      </div>
    </div>
